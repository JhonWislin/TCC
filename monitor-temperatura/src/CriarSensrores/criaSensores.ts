...
// Essa capacidade é atribuida a cada estção de metro (seasons)
//node --loader ts-node/esm src/criaSensores.ts (para rodar o arquivo)
const seasons = [
    {
  ...
  export async function main() {
    ...
    for (const recurso of seasons) { // Para cada recursos de semáforo 
      ...
      const data = ((await result.json()) as any).data; // Dados do recurso criado (uuid, capabilities)
